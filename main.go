...
func FlyURL() string {
	return "https://mohamadfikriariqsyarahman-final-project-be2620498.fly.dev" // TODO: replace this
}

func main() {
	//TODO: hapus jika sudah di deploy di fly.io
	os.Setenv("DATABASE_URL", "postgres://postgres:takuya123@localhost:5432/kanbanApp")
